...
const variantToStyle: Record<ButtonVariant, string> = {
  ...
  secondary:
    'text-white bg-[var(--primary-color)] hover:bg-white hover:text-[var(--active-icon-color)]',
  static: '',
};
...
export default function IconButton({
  ...
  const sizeStyle = typeof size === 'number' ? `w-[${size}px] h-[${size}px]` : sizeToStyle[size];
  ...
  return (
    <button className={clsx(baseStyles, sizeStyle, variantStyle, color, className)} {...props}>
      <span
